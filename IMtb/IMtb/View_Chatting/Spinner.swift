...
struct Spinner: View {
    ...
    let animationTime: Double = 2 // Sum of all animation times
...
//                .edgesIgnoringSafeArea(.all)
            ...
            ZStack {
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: Color("LoadingColor1"))

                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: Color("LoadingColor2"))

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: Color("LoadingColor3"))
